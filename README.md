...
## File Location
- Main Files are found in part_1_mars_news and part_2_mars_weather
- Output csv and matplotlib charts are found in the output folder
- Some refrence class materials are found in the refrences folder
