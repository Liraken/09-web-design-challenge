...
- **`part_1_mars_news.ipynb`**: Contains the work for part 1 of this assignment
- **`part_2_mars_weather.ipynb`**: Contains the work for part 2 of this assignment
- **`output/`**: Contains the output files for mars_news and mars_weather.
- **`Notes/`**: Contains any relevant notes if any exist.

## Sources / References
* Header image: NA
* Repos used as reference: NA
